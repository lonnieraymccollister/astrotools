...
class EllipseWidget(QtWidgets.QWidget):
    def __init__(self, parent=None):
        ...
        # NEW CHECKBOX
        self.chkShowFoci = QtWidgets.QCheckBox("Show Foci Instead of Center")
        self.chkShowFoci.setChecked(False)
        ...
        # ADD CHECKBOX HERE — after btnLayout exists
        btnLayout.addWidget(self.chkShowFoci)
    ...
    def fitEllipse(self):
        ...
        # Foci positions
        fx1 = cx + c * np.cos(theta)
        fy1 = cy + c * np.sin(theta)
